...
{
public:
	DepthFuncState( Function fun ) :
	  RenderStateNonIndexed( RS_DepthFunc ), func( fun ) {}
...
public:
	AtomicCounter() :
	  RenderStateIndexed( RS_AtomicCounterBuffer ) {}
...
public:
	UniformBufferObject() :
	  RenderStateIndexed( RS_UniformBuffer ) {}
...
public:
	ShaderStorageBufferObject() :
	  RenderStateIndexed( RS_ShaderStorageBuffer ) {}
...
public:
	...
	BlendFuncState() :
	  RenderStateNonIndexed( RS_BlendFunc ) {}
	void Apply( int index, const Camera *camera, RenderContext *context ) const override;
...
public:
	BlendEquationState() :
	  RenderStateNonIndexed( RS_BlendEquation ) {}
...
public:
	CullFaceState() :
	  RenderStateNonIndexed( RS_CullFace ) {}
	CullFaceState( PolygonFace face ) :
	  RenderStateNonIndexed( RS_CullFace ), face( face ) {}
	void Apply( int index, const Camera *camera, RenderContext *context ) const override;
...
public:
	FrontFaceState() :
	  RenderStateNonIndexed( RS_FrontFace ) {}
	FrontFaceState( FrontFace face ) :
	  RenderStateNonIndexed( RS_FrontFace ), face( face ) {}
	void Apply( int index, const Camera *camera, RenderContext *context ) const override;
...
{
public:
	LineWidthState( float width ) :
	  RenderStateNonIndexed( RS_LineWidth ), lineWidth( width ) {}
	void Apply( int index, const Camera *camera, RenderContext *context ) const override;
...
public:
	PolygonModeState() :
	  RenderStateNonIndexed( RS_PolygonMode ) {}
	PolygonModeState( PolygonMode front, PolygonMode back ) :
	  RenderStateNonIndexed( RS_PolygonMode ), frontMode( front ), backMode( back ) {}
	void Apply( int index, const Camera *camera, RenderContext *context ) const override;
